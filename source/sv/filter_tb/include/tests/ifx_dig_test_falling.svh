...
class ifx_dig_test_falling extends ifx_dig_testbase;

    `uvm_component_utils(ifx_dig_test_falling)
    ...
    function new(string name = "ifx_dig_test_falling", uvm_component parent);
