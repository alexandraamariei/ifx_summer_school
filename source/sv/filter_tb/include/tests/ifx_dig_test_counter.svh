...
class ifx_dig_test_counter extends ifx_dig_testbase;

    `uvm_component_utils(ifx_dig_test_counter)

    function new(string name = "ifx_dig_test_counter", uvm_component parent);
